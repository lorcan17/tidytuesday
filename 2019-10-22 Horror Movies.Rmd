...
First question I have: does the ratings increase as the number of movies a director films increases?
...
```{r}
horror_movies %>% filter(lm(review_rating ~ release_country, data = .) %>% anova() %>% tidy()
```
